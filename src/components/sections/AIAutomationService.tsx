...
const expertiseItems = [
  {
    icon: HiTag,
    label: "OpenAI / GPT-4",
    desc: "State-of-the-art language models tuned for your business.",
  },
  {
    icon: HiCpuChip,
    label: "AI Agents",
    desc: "Autonomous workflows that reason and act on context.",
  },
  {
    icon: HiWrenchScrewdriver,
    label: "Make.com",
    desc: "Visual automation connecting your entire stack.",
  },
  { icon: HiServer, label: "HubSpot + APIs", desc: "CRM, lead routing, and full API integration." },
];
...
const includedItems = [
  {
    icon: HiCpuChip,
    title: "AI Models",
    desc: "Custom-trained AI models for your specific business needs.",
  },
  {
    icon: HiWrenchScrewdriver,
    title: "Automation",
    desc: "End-to-end workflow automation with Make.com & Zapier.",
  },
  {
    icon: HiDevicePhoneMobile,
    title: "Dashboards",
    desc: "Real-time analytics & performance monitoring.",
  },
...
const processSteps = [
  {
    ...
    title: "Audit",
    desc: "Analyze existing workflows & identify automation opportunities.",
  },
  {
    icon: HiPencilSquare,
    title: "Design",
    desc: "Architect the AI solution & integration blueprint.",
  },
  { icon: HiCpuChip, title: "Build", desc: "Develop AI models, chatbots & automation pipelines." },
  {
    icon: HiRocketLaunch,
    title: "Deploy",
    desc: "Launch, test & integrate into your live environment.",
  },
];

const toolsRow1 = [
  { icon: HiCpuChip, label: "OpenAI" },
  { icon: HiSparkles, label: "Claude" },
  { icon: HiLink, label: "LangChain" },
  { icon: HiArrowRight, label: "GPT-4" },
  { icon: HiWrenchScrewdriver, label: "Make.com" },
];

const toolsRow2 = [
  { icon: HiChatBubbleLeftRight, label: "Vapi" },
  { icon: HiCircleStack, label: "Tidio AI" },
  { icon: HiEnvelope, label: "Resend" },
  { icon: HiUserGroup, label: "HubSpot" },
  { icon: HiCodeBracket, label: "Zapier" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-20 md:space-y-28">
              ...
              <div className="space-y-4 md:space-y-8 lg:text-center lg:max-w-4xl lg:mx-auto">
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto text-center">
                    Streamline operations, qualify leads, and scale support with custom AI solutions
                ...
                >
                  {[
                    { target: "50", suffix: "K+", label: ["Hours", "Saved"] },
        ...
        >
          ...
          <p className="text-white text-sm sm:text-base font-medium leading-relaxed mb-6 relative z-10">
            AI isn’t just a buzzword — it’s the competitive edge your business needs. Intelligent
            automation reduces costs, eliminates human error, and scales your operations
            exponentially without adding headcount.
          </p>
          {/* Stat Badges */}
            ...
            {[
              {
                ...
                stat: "-85%",
                label: "Manual Tasks",
                sub: "eliminated from operations",
              },
              { icon: HiCircleStack, stat: "24/7", label: "Coverage", sub: "autonomous runtime" },
              {
                icon: HiUserGroup,
                stat: "+47%",
                label: "Lead Conversion",
                sub: "AI-scored vs. manual",
              },
            ].map((s) => (
              <div
                key={s.label}
        ...
        <div>
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black tracking-tight leading-[0.95] mt-3">
            AI & Automation<span className="text-amber"> Services</span>
          </h2>
        </div>
          ...
          {[
            {
              ...
              title: "AI Chatbots",
              subtitle: "The Agent",
              desc: "Intelligent 24/7 customer support agents that handle inquiries, book appointments, and resolve issues autonomously.",
              steps: chatbotSteps,
            },
            {
              ...
              subtitle: "The Filter",
              desc: "AI-powered lead scoring and routing that ensures your sales team only talks to qualified prospects.",
              steps: leadSteps,
            },
            {
              icon: HiCircleStack,
              ...
              subtitle: "The Engine",
              desc: "End-to-end process automation connecting your tools and eliminating manual repetitive work.",
              steps: workflowSteps,
            },
            {
              icon: HiLink,
              title: "Custom APIs",
              subtitle: "The Bridge",
              desc: "Bespoke API integrations that connect your CRM, billing, support, and internal tools into one unified system.",
              steps: apiSteps,
            },
            {
              icon: HiEnvelope,
              ...
              subtitle: "The Inbox",
              desc: "Intelligent email automation that handles inquiries, follow-ups, and nurturing sequences 24/7.",
              steps: emailSteps,
            },
            {
              icon: HiDevicePhoneMobile,
              title: "AI Receptionist",
              subtitle: "The Front Desk",
              desc: "Voice and chat AI that answers calls, books appointments, and qualifies prospects around the clock.",
        ...
        >
          ...
          <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-black leading-[0.95] mb-5 text-white max-w-3xl mx-auto relative z-10">
            Let’s automate your <span className="text-amber">workflows</span>.
          </h3>
