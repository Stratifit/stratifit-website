...
const expertiseItems = [
  { icon: HiPencil, label: "Figma", desc: "Real-time collaborative design & prototyping." },
  {
    icon: HiPhoto,
    label: "Adobe Suite",
    desc: "Illustrator, Photoshop & InDesign for premium assets.",
  },
  { icon: HiLanguage, label: "Typography", desc: "Curated typefaces that define brand voice." },
  { icon: HiSquares2X2, label: "Design Systems", desc: "Reusable component libraries that scale." },
];
...
const includedItems = [
  {
    icon: HiFolderOpen,
    title: "Master Files",
    desc: "Vector Suite & Raster Files for all applications.",
  },
...
const processSteps = [
  {
    ...
    title: "Discovery",
    desc: "Researching brand DNA & market positioning.",
  },
...
const toolsRow1 = [
  ...
  { icon: HiSparkles, label: "Illustrator" },
  { icon: HiPhoto, label: "Photoshop" },
  { icon: HiDocumentText, label: "InDesign" },
  { icon: HiViewColumns, label: "After Effects" },
];

const toolsRow2 = [
  { icon: HiMap, label: "Cinema 4D" },
  { icon: HiCube, label: "Framer" },
  { icon: HiGlobeAlt, label: "Webflow" },
  { icon: HiPencilSquare, label: "Sketch" },
  { icon: HiLanguage, label: "Lottie" },
];

export function BrandDesign() {
  const router = useRouter();

  const caseStudies = projects.filter((p) => p.category === "Brand Design");
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-24 md:space-y-32">
              ...
              <div className="space-y-4 md:space-y-8 lg:text-center lg:max-w-4xl lg:mx-auto">
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto text-center">
                    We craft strategic visual identities designed to drive valuation and establish
                    market authority from day one.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <a
                    href="#how-it-works"
                    className="group px-6 sm:px-8 py-3.5 sm:py-4 border border-white/15 text-white font-semibold rounded-xl flex items-center justify-center gap-2 sm:gap-3 hover:border-amber/50 hover:text-amber transition-all active:scale-95 text-sm sm:text-base"
                  >
                    <HiSparkles className="shrink-0" />
                    How We Work
                    <HiArrowRight className="group-hover:translate-x-1 transition-transform shrink-0" />
                  </a>
                </motion.div>
        ...
        >
          ...
          <p className="text-white text-sm sm:text-base font-medium leading-relaxed mb-6 relative z-10">
            Strategic branding is the architectural foundation of market authority. Beyond
            aesthetics, it drives business valuation, secures investor trust, and builds long-term
            equity by creating an emotionally memorable connection that scales with your vision.
          </p>
            ...
            {[
              {
                ...
                stat: "2×",
                label: "Faster Growth",
                sub: "vs. unbranded competitors",
              },
              {
                icon: HiShieldCheck,
                stat: "77%",
                label: "Consumer Trust",
                sub: "driven by brand consistency",
              },
              {
                icon: HiGlobeAlt,
                stat: "89%",
                label: "Revenue Impact",
                sub: "from strategic positioning",
              },
            ].map((s) => (
              <div
                key={s.label}
          ...
          {[
            {
              ...
              desc: "A deep dive into your market, audience, and goals to build a roadmap for long-term success and distinct positioning.",
              steps: strategySteps,
            },
            {
              icon: HiPencil,
              title: "Logo Design",
              subtitle: "The Face",
              desc: "Crafting a memorable, scalable, and timeless mark that serves as the cornerstone of your brand's visual presence.",
              steps: logoSteps,
            },
            {
              icon: HiFingerPrint,
              ...
              subtitle: "The System",
              desc: "Full color palettes, typography, and asset libraries designed for absolute cohesion across every touchpoint.",
              steps: identitySteps,
            },
            {
              icon: HiBookOpen,
              ...
              desc: "A comprehensive manual ensuring your team and partners use your brand assets correctly and consistently forever.",
              steps: guidelinesSteps,
            },
          ].map((service, idx) => (
            <motion.div
              key={service.title}
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed text-sm mb-8">
                <span className="text-amber font-bold">{service.subtitle}:</span> {service.desc}
              </p>

              <h3 className="text-amber font-bold text-xs uppercase tracking-widest mb-4">
                How We Do It
              </h3>
              <div className="grid grid-cols-2 gap-3">
                {service.steps.map((step) => (
                  ...
                  >
                    <step.icon className="text-amber text-lg md:text-2xl mb-2" />
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-heading font-black leading-[0.95] mb-3 text-white max-w-xl mx-auto relative z-10">
            Let’s craft your brand <span className="text-amber">story</span>.
          </h3>
