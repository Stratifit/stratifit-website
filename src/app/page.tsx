...
function ComingSoonGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        {/* Floating skill icon tiles (website / brand / AI / funnel / marketing) */}
        {/* Browser frame — Website Development */}
        <div className="absolute top-[8%] left-[6%] w-[52px] h-[52px] sm:w-[68px] sm:h-[68px] drift-a">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.13] drop-shadow-[0_0_10px_rgba(245,158,11,0.3)]">
        ...
        <div className="absolute top-[14%] right-[10%] w-[60px] h-[60px] sm:w-[80px] sm:h-[80px] drift-b">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.14] drop-shadow-[0_0_12px_rgba(245,158,11,0.3)]">
            <path d="M12 3a9 9 0 1 0 9 9 4 4 0 0 1-4-4 4 4 0 0 1-4-4z" />
        ...
        {/* Diamond — Logo / Brand */}
        <div className="absolute top-[42%] left-[8%] w-[50px] h-[50px] sm:w-[64px] sm:h-[64px] drift-c">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round" className="w-full h-full text-amber/[0.12] drop-shadow-[0_0_10px_rgba(245,158,11,0.25)]">
            <path d="M12 3l9 9-9 9-9-9z" />
            <path d="M3 12h18" />
            <path d="M12 3l-3 9h6z" />
          </svg>
        </div>

        {/* CPU chip — AI & Automation */}
        <div className="absolute top-[36%] right-[8%] w-[60px] h-[60px] sm:w-[80px] sm:h-[80px] drift-d">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.14] drop-shadow-[0_0_12px_rgba(245,158,11,0.3)]">
        ...
        <div className="absolute top-[54%] left-[10%] sm:left-[28%] w-[56px] h-[56px] sm:w-[72px] sm:h-[72px] drift-b">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.13] drop-shadow-[0_0_10px_rgba(245,158,11,0.3)]">
        ...
        <div className="absolute bottom-[26%] left-[14%] w-[52px] h-[52px] sm:w-[68px] sm:h-[68px] drift-a">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.12] drop-shadow-[0_0_10px_rgba(245,158,11,0.25)]">
            <polygon points="22 3 2 3 10 12.5 10 19 14 21 14 12.5" />
          </svg>
        </div>

        {/* Megaphone — Growth Marketing */}
        <div className="absolute bottom-[44%] right-[20%] sm:right-[26%] w-[54px] h-[54px] sm:w-[70px] sm:h-[70px] drift-c">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.12] drop-shadow-[0_0_10px_rgba(245,158,11,0.25)]">
        ...
        {/* Globe — Buy a Business */}
        <div className="absolute bottom-[24%] right-[12%] w-[60px] h-[60px] sm:w-[78px] sm:h-[78px] drift-d">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full text-amber/[0.13] drop-shadow-[0_0_12px_rgba(245,158,11,0.3)]">
