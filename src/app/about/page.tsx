...
import { HiArrowLeft, HiSparkles, HiChartBar, HiUserGroup, HiGlobeAlt, HiRocketLaunch } from "react-icons/hi2";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black leading-tight md:leading-none tracking-tight mb-4">
              About{" "}
              <span className="text-amber">Stratifit</span>
            </h1>
          ...
          >
            {[
              ...
              >
                ...
                <span className="text-white font-heading font-black text-2xl md:text-3xl">{s.stat}</span>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed border-l-2 border-amber/30 pl-4 sm:pl-6">
              ...
              technology they need to dominate their markets. We combine
              creative excellence with technical precision to deliver digital
              products that drive measurable business results.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed border-l-2 border-amber/30 pl-4 sm:pl-6">
              ...
              with startups and enterprises alike — delivering brand identities,
              web platforms, AI automation systems, and growth engines that
              transform how businesses operate and scale.
            </p>
          </motion.div>
