...
// TODO(admin): wire events[] to a real audit log. Today this is illustrative
// scaffolding \u2014 once the activity_log Supabase table exists, replace this
// with a server-side query result and drop the in-file array entirely.
const events = [
  { id: "e-1", ts: "2026-07-10 \u00b7 14:32", actor: "admin@stratifit.com", verb: "published", target: '"How to Scale AI"', type: "publish" },
  { id: "e-2", ts: "2026-07-10 \u00b7 13:48", actor: "lead-bot", verb: "captured", target: "new lead", type: "lead" },
  { id: "e-3", ts: "2026-07-10 \u00b7 12:15", actor: "system", verb: "synced Stripe", target: "payment data", type: "sync" },
  { id: "e-4", ts: "2026-07-10 \u00b7 11:02", actor: "admin@stratifit.com", verb: "edited", target: "Website Development pricing", type: "edit" },
  { id: "e-5", ts: "2026-07-10 \u00b7 09:48", actor: "lead-bot", verb: "sent email", target: "via Resend", type: "email" },
  { id: "e-6", ts: "2026-07-09 \u00b7 22:11", actor: "v.bidder@linnea.co", verb: "submitted bid on", target: "Linnea Couture", type: "bid" },
  { id: "e-7", ts: "2026-07-09 \u00b7 19:05", actor: "mira@stratifit.com", verb: "added testimonial from", target: "Linnea Couture", type: "edit" },
  { id: "e-8", ts: "2026-07-09 \u00b7 17:42", actor: "system", verb: "auto-renewed", target: "subscription", type: "billing" },
  { id: "e-9", ts: "2026-07-09 \u00b7 14:30", actor: "theo@stratifit.com", verb: "joined team as", target: "Viewer", type: "team" },
  { id: "e-10", ts: "2026-07-09 \u00b7 09:00", actor: "admin@stratifit.com", verb: "updated", target: "password policy", type: "edit" },
];
